...
<div class="page-hero">
  <div class="page-hero-inner">
    <p class="breadcrumb"><a href="{{ '/' | relative_url }}">Home</a> / Networks &amp; Registry</p>
    <h1>Networks &amp; Registry</h1>
    <p class="subtitle">Register, connect, and grow through ISRK's research and professional networks</p>
  </div>
</div>
...
<div class="registry-section" style="margin-top:1.5rem; border-left-color: var(--saffron); text-align:center;">
  ...
  <div style="margin-top:1rem;">
    <a href="https://open.kakao.com/o/g5y5TPli" target="_blank" class="btn btn-primary" style="background:var(--saffron);border-color:var(--saffron);">&#128172; Join on KakaoTalk</a>
  </div>
</div>
...
<div class="registry-section" style="margin-top:1.5rem; border-left-color: var(--navy); text-align:center;">
  ...
  <p class="registry-subtitle" style="margin-left:auto; margin-right:auto;">A dedicated network for Indian researchers and students working in semiconductor science and engineering across Korean universities and institutes.</p>
  <div style="margin-top:1rem;">
    <a href="https://chat.whatsapp.com/BQHm8ovHqoH44TMnJ3ABDy" target="_blank" class="btn btn-primary">&#129309; Join Now on WhatsApp</a>
  </div>
</div>

<div class="registry-section" style="margin-top:1.5rem; border-left-color: var(--cyan); text-align:center;">
  <h2 class="registry-title">&#129302; AI &amp; Robotics Research Network</h2>
  <p class="registry-subtitle" style="margin-left:auto; margin-right:auto;">Connecting Indian researchers and students in Artificial Intelligence and Robotics across Korea for collaboration, knowledge exchange, and industry engagement.</p>
  <div style="margin-top:1rem;">
    <a href="https://chat.whatsapp.com/II5ZBgb6hrmEe22yIDpHSY" target="_blank" class="btn btn-primary">&#129309; Join Now on WhatsApp</a>
  </div>
</div>

<div class="registry-section" style="margin-top:1.5rem; border-left-color: #27ae60; text-align:center;">
  <h2 class="registry-title">&#128267; Battery Research Network</h2>
  <p class="registry-subtitle" style="margin-left:auto; margin-right:auto;">A dedicated network for Indian researchers and students working in battery technology, energy storage, and electrochemistry across Korean universities and institutes.</p>
  <div style="margin-top:1rem;">
    <a href="https://chat.whatsapp.com/LuXJlMFFGHf0ep0TG3Kaie" target="_blank" class="btn btn-primary">&#129309; Join Now on WhatsApp</a>
  </div>
</div>
